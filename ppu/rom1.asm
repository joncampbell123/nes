; TEST ROM #1:
; PPU + PALETTE PROGRAMMING
; WITH ASCII CHARACTER MAP IN CHR-ROM
; (C) 2012 JONATHAN CAMPBELL
;
; LANGUAGE: 6502 Assembly language
;           Assemble with ACME assembler
;           Makefile will assemble this and other files into working .NES file you can run in NES emulators
